...
let vetor2 = []   // Forma "tradicional"

// Criação de vetores com valores iniciais
let vetor3 = [2, 4, 6, 8, 10]
let vetor4 = ('vaca', 'cachorro', 'gato', 'papagaio')
...
// 2º parâmetros: quantos elementos serão eliminados (para inserção ==0)
...
// Forma 1: usando o for tradiconal
...
// Forma 3: forEach()
// O argumento do for Each() é uma função que recebe
